...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ProductionProduct>
 */
class ProductionProductFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        $unitCost = $this->faker->randomFloat(2, 10, 200);
    ...
    /**
     * Indicate that the production product belongs to a specific production.
     */
    ...
    /**
     * Indicate that the production product is a specific product.
     */
    ...
    /**
     * Indicate that the production product is stored at a specific storage location.
     */
